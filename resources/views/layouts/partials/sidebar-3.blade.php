            ...
            <ul>
                ...
                <li class="submenu ">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('product.showroom') }}"
                                class="{{ request()->is('admin/products/showroom') ? 'active' : '' }}">Showroom Product
                                List</a></li>

                        <li><a href="{{ route('product.godown') }}"
                                class="{{ request()->is('admin/products/godown') ? 'active' : '' }}">Godown Product
                                List</a></li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('subCategory.index') }}"
                                class="{{ request()->is('admin/subCategories') ? 'active' : '' }}">Sub Category</a></li>

                        <li><a href="{{ route('brand.index') }}"
                                class="{{ request()->is('admin/brands') ? 'active' : '' }}">Brand</a></li>
                        ...
                        <li><a href="{{ route('unit.index') }}"
                                class="{{ request()->is('admin/units') ? 'active' : '' }}">Unit</a></li>
                    </ul>
                </li>

                {{-- <li>
                    <a href="{{ url('/admin/documents') }}" target="_blank"><img
                            src="{{asset('backend')}}/img/icons/purchase1.svg" alt="img"><span> Documentations</span>
                    </a>
                </li> --}}
