    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="row">
                ...
                <div class="col-md-10" class="contents">
                ...
                <div class="col-md-2 d-flex justify-content-end" style="margin-top: -6px;">
                    ...
                    {{-- <select name="links" id="" size="1" onchange="window.location.href=this.value;" class="form-select form-select-lg mb-3" style="width: 2033px; height: 42px; font-size: 16px;"> --}}
                        ...
                        <select name="links" id="" size="1" onchange="window.location.href=this.value;" class="form-select form-select-lg mb-3" style="width: 2029px;height: 42px;font-size: 16px;padding-left: 22px;">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="dash-widget sherazi1">
                        ...
                        <div class="dash-widgetcontent">
                            ...
                            <h6>Daily Purchase Stock Qty</h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="dash-widget sherazi2">
                        ...
                        <div class="dash-widgetcontent">
                            ...
                            <h6>Daily Purchase Stock Amount</h6>
                        </div>
                    </div>
                </div>
