    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{ route('country.create') }}" class="btn btn-added"><img
                            src="{{ asset('backend') }}/img/icons/plus.svg" class="me-2" alt="img">Add Country</a>
                </div>
            </div>
                            ...
                            <tbody>
                                @foreach ($countries as $country)
                                    <tr>
                                        ...
                                        <td>{{ $country->name }}</td>
                                        <td>
                                            <a class="me-3" href="{{ route('country.edit', $country->id) }}">
                                                <img src="{{ asset('backend') }}/img/icons/edit.svg" alt="img">
                                            </a>
                                            {{-- <a class="me-3 confirm-text"
                                                href="{{ route('country.destroy', $country->id) }}">
