...
<div class="page-wrapper">
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('purchaseReturn.create') }}" class="btn btn-added">
                    <img src="{{asset('backend')}}/img/icons/plus.svg" alt="img" class="me-2">Add Purchase Return
                </a>
            </div>
        </div>
        <!-- /product list -->
                    ...
                    <table class="table" id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td>
                                    <a class="me-3" href="{{ route('purchaseReturn.edit',$purchaseReturn->id) }}">
                                        <img src="{{asset('backend')}}/img/icons/edit.svg" alt="img">
                                    </a>
                                    <a class="me-3 confirm-text" href="{{ route('purchaseReturn.delete',$purchaseReturn->id) }}">
                                ...
                                <td class="text-center">
                                    ...
                                    <ul class="dropdown-menu"  >
                                        ...
                                        {{-- <li>
                                            <a href="{{ route('purchaseReturn.edit',$purchaseReturn->id) }}" class="dropdown-item"><img src="{{asset('backend')}}/img/icons/edit.svg" class="me-2" alt="img">Edit Purchase</a>
                                        </li> --}}
                                        ...
                                        <li>
                                            <a href="{{ route('purchaseReturn.delete',$purchaseReturn->id) }}" class="dropdown-item confirm-text"><img src="{{asset('backend')}}/img/icons/delete1.svg" class="me-2" alt="img">Delete Purchase</a>
                                        </li>								
                                    </ul>
                                </td>
                            </tr>
