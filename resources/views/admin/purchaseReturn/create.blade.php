                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="ref_code" value="<?php echo $randNumber; ?>" readonly>
                            </div>
                        </div>
...
<script>
    ...
    function testClick(product){
            ...
            var htmldata =`<tr>
                        ...
                        <td class="text-end" >
                        <input type="text" readonly class="inline_total" name="sub_total[]" value="${product.purchase_price}" style="width:100px;">
                        </td>
                        <td>
