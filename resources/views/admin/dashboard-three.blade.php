    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="row">
                ...
                <div class="col-md-10">
                    <center><h3> Yearly Report</h3></center>
                </div>
                ...
                <div class="col-md-2 d-flex justify-content-end" style="margin-top: -6px;">
                    ...
                    <select name="links" id="" size="1" onchange="window.location.href=this.value;" class="form-select form-select-lg mb-3" style="width: 183px; height: 42px; font-size: 16px;">
                    ...
                    // $carbonToDay =  Carbon\Carbon::year();
                    $stockqty = App\Models\PurchaseItem::whereYear('created_at', date('Y'))->sum('quantity');
                    $stockamount= App\Models\Purchase::whereYear('created_at', date('Y'))->sum('grandtotal');
                    $saleamount= App\Models\Sale::whereYear('created_at', date('Y'))->sum('grandtotal');
                    $receiveamount= App\Models\Sale::whereYear('created_at', date('Y'))->sum('paid_amount');
                    $dueamount= App\Models\Sale::whereYear('created_at', date('Y'))->sum('due_amount');
                    $emipay= App\Models\CustomerPayment::whereYear('created_at', date('Y'))->sum('paying_amount');
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="dash-widget dash2 sherazi1">
                        ...
                        <div class="dash-widgetcontent">
                            ...
                            <h6> Yearly Due Amount </h6>
                        </div>
                    </div>
                </div>

                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="dash-widget dash2 sherazi2">
                        <div class="dash-widgetimg">
                            <span><img src="{{ asset('backend') }}/img/icons/dash3.svg" alt="img"></span>
                        </div>
                        <div class="dash-widgetcontent">
                            <h5>৳<span class="counters" data-count="{{ $emipay}}"></span></h5>
                            <h6> Yearly EMI Pay Amount </h6>
                        </div>
                    </div>
                </div>
