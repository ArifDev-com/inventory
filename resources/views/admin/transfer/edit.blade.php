            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>From</label>
                            <select class="select" name="from_warehouse_id">
                                @foreach ($warehouses as $warehouse)
                                <option value="{{ $warehouse->id }}"
                                    {{ $warehouse->id == $transfer->warehouse_id ? 'selected' : '' }}>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>To</label>
                            <select class="select" name="to_warehouse_id">
                                @foreach ($warehouses as $warehouse)
                                <option value="{{ $warehouse->id }}"
                                    {{ $warehouse->id == $transfer->warehouse_id ? 'selected' : '' }}>
                                    {{ $warehouse->name }}</option>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="ref_code" value="{{ $transfer->ref_code }}">
                        </div>
                    </div>
                <div class="row">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <input type="hidden" name="product_id[]"  class="form-control product_id"  value="{{ $item->product->id }}">
                                    ...
                                    <td>
                                        <a href="javascript:void(0);"><img src="{{asset('backend')}}/img/icons/delete.svg" alt="svg"></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div class="col-lg-12 float-md-right">
                        <div class="total-order">
                            <ul>
                                ...
                                <li class="total">
                                    <h4>Grand Total</h4>
                                    <input type="text" readonly class="total_val" name="grand_total" value="{{ $transfer->grandtotal }}" style="margin-left:30px;">
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="tax" value="{{ $transfer->tax }}" id="tax_val">
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Discount</label>
                            <input type="text" name="discount" value="{{ $transfer->discount }}" id="discount_val">
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Shipping</label>
                            <input type="text" name="shipping" value="{{ $transfer->shipping }}" id="shipping_val">
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <select class="select" name="status" >
                                ...
                                <option value="completed" {{ $transfer->status == 'completed' ? 'selected' : '' }}>Completed
                                </option>
                                <option value="pending" {{ $transfer->status == 'pending' ? 'selected' : '' }}>Pending
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            <label>Item</label>
                            <input type="text" name="item" value="{{ $transfer->item }}">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
