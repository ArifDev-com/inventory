...
<div class="page-wrapper">
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{route('transfer.create') }}" class="btn btn-added"><img src="{{asset('backend')}}/img/icons/plus.svg" alt="img" class="me-2">Add Transfer</a>
            </div>
        </div>
                    ...
                    <table class="table" id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $key+1 }}</td>
                                <td>{{ $transfer->date }}</td>
                                <td>{{ $transfer->ref_code }}</td>
                                <td>{{ $transfer->from_warehouse->name }}</td>
                                <td>{{ $transfer->to_warehouse->name }}</td>
                                <td>{{ $transfer->item}}</td>
                                <td>{{ $transfer->grandtotal }}</td>
                                <td><span class="badges bg-lightgreen">{{ $transfer->status }}</span></td>
                                {{-- <td>
                                    <a class="me-3" href="{{ route('transfer.edit',$transfer->id) }}">
                                        <img src="{{asset('backend')}}/img/icons/edit.svg" alt="img">
                                    </a>
                                    <a class="me-3 confirm-text" href="{{ route('transfer.delete',$transfer->id) }}">
                                ...
                                <td class="text-center">
                                    ...
                                    <ul class="dropdown-menu"  >
                                        ...
                                        {{-- <li>
                                            <a href="{{ route('transfer.edit',$transfer->id) }}" class="dropdown-item"><img src="{{asset('backend')}}/img/icons/edit.svg" class="me-2" alt="img">Edit Sale</a>
                                        </li> --}}
                                        ...
                                        <li>
                                            <a href="{{ route('transfer.pdf',$transfer->id) }}" class="dropdown-item"><img src="{{asset('backend')}}/img/icons/download.svg" class="me-2" alt="img">Print Invoice</a>
                                        </li>	
                                        <li>
                                            <a href="{{ route('transfer.delete',$transfer->id) }}" class="dropdown-item confirm-text"><img src="{{asset('backend')}}/img/icons/delete1.svg" class="me-2" alt="img">Delete Sale</a>
                                        </li>								
                                    </ul>
                                </td>
                            </tr>
