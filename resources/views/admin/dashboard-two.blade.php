        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-md-2 d-flex justify-content-end" style="margin-top: -6px;">
                    ...
                    $stockqty = App\Models\PurchaseItem::whereMonth('created_at', date('m'))->sum('quantity');
                    $stockamount= App\Models\Purchase::whereMonth('created_at', date('m'))->sum('grandtotal');
                    $saleamount= App\Models\Sale::whereMonth('created_at', date('m'))->sum('grandtotal');
                    $receiveamount= App\Models\Sale::whereMonth('created_at', date('m'))->sum('paid_amount');
                    $dueamount= App\Models\Sale::whereMonth('created_at', date('m'))->sum('due_amount');
                    $emipay= App\Models\CustomerPayment::whereMonth('created_at', date('m'))->sum('paying_amount');
