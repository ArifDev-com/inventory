    ...
    <div class="page-wrapper">
        <div class="content">
           ...
           @endphp
                ...
                <div class="col-md-10">
                    <center><h3>Warehouse: {{ $warehouses->name}}</h3></center>
                </div>
...
$stockqty = App\Models\Product::where('warehouse_id', 5)->sum('quantity');
$stockamount= App\Models\Purchase::where('warehouse_id', 5)->sum('grandtotal');
$saleamount= App\Models\Sale::where('warehouse_id', 5)->sum('grandtotal');
$receiveamount= App\Models\Sale::where('warehouse_id', 5)->sum('paid_amount');
$dueamount= App\Models\Sale::where('warehouse_id', 5)->sum('due_amount');
