...
<body>
  <br><br>
  <center>
    <h1 style="color: white; margin-bottom: 10px;"><span class="">Reset New Password</span></h1>
  </center>
  ...
  <form action="{{route('update.reset.password')}}" method="post" class="login">
    @csrf
    ...
    <input type="password" name="password" id="password-field" class="left" placeholder="New Password" />
    @error('password')
    <span class="text-danger" style="color: red;">{{ $message }}</span>
    @enderror
    ...
    <center>
      ...
      <a href="{{ route('forgot.password')}}" style="color: #242b77; font-size: 16px; font-weight: bold;">Back OTP</a>
