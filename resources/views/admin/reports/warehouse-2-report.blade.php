    ...
    <div class="content">
        <div class="page-header">
           ...
           @endphp
                    ...
                    <h4>Warehouse : {{ $warehouses2->name}} - Sales List</h4>
       ...
       @endphp
            ...
            <div class="page-btn">
                <a href="{{ route('product.warehouse-2.list') }}" class="btn btn-added"><img src="" class="me-1">Click - {{ $warehouses->name}} - Product List </a>
            </div>
