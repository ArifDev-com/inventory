    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>Extra Expense Category Add</h4>
                <h6>Create new Extra Expense Category</h6>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    {{-- <form action="{{ route('expense.category.store') }}" method="POST" enctype="multipart/form-data"> --}}
                        <form action="{{ route('extra.expense.category.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
