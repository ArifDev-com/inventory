    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-3">
                        <a href="{{ route('reports.datewise-stock') }}">
                            <div class="card " style="background: linear-gradient(to right, #78ffd6, #a8ff78);">
                                <center><i class="fa fa-box mt-4" style="font-size: 45px;"></i>
                                </center>
                                <div class="card-body">
                                    <center>
                                        <h1 class="card-title">
                    ...
                    <div class="col-md-3">
                        <a href="{{ route('reports.datewise-sale') }}">
                            <div class="card " style="background: linear-gradient(to right, #78ffd6, #a8ff78);">
                        ...
                        <a href="{{ route('sale.report') }}">
                            <div class="card " style="background: linear-gradient(to right, #78ffd6, #a8ff78);">
                                ...
                                <div class="card-body">
                                    ...
                                    <center>
                                        <h1 class="card-title">Sales Reports</h1>
                                    </center>
                        ...
                        <a href="{{ route('profit.loss') }}">
                            <div class="card " style="background: linear-gradient(to right, #78ffd6, #a8ff78);">
                                ...
                                <div class="card-body">
                                    ...
                                    <center>
                                        <h1 class="card-title">Profit or Loss</h1>
                                    </center>
                        ...
                        <a href="{{ route('invoice.report') }}">
                            <div class="card " style="background: linear-gradient(to right, #78ffd6, #a8ff78);">
                                ...
                                <div class="card-body">
                                    ...
                                    <center>
                                        <h1 class="card-title">Invoice Report</h1>
                                    </center>
                        ...
                        <a href="{{ route('due.report') }}">
                            <div class="card " style="background: linear-gradient(to right, #78ffd6, #a8ff78);">
                                ...
                                <div class="card-body">
                                    ...
                                    <center>
                                        <h1 class="card-title">Due Report</h1>
                                    </center>
