...
<body>
    ...
    <div class="table-section bill-tbl w-100 ">
        <div class="table w-100 ">
            ...
            <div>
                ...
                <p style="margin-left: 550px; font-size: 12px; margin-top: -15px;">Address: 225/5, Safiuddin Road,
                    Tongi, Gazipur.</p>
                <p style="margin-left: 550px; font-size: 12px; font-weight: bold; margin-top: 0px;">Invoice Date: {{
    ...
    <div class="add-detail mt-10">
        <div class="w-50 float-left mt-10">
            <p class="m-0 pt-5 text-bold w-100">Invoice Number: <span class="gray-color">{{ $sale->ref_code }}</span>
            </p>
            <p class="m-0 pt-5 text-bold w-100">Customer Name: <span class="gray-color">{{ $sale->customer->name
                    }}</span></p>
            <p class="m-0 pt-5 text-bold w-100">Phone: <span class="gray-color">{{ $sale->customer->phone }}</span></p>
            <p class="m-0 pt-5 text-bold w-100">Address: <span class="gray-color">{{ $sale->customer->address }}</span>
            </p>
                ...
                <td colspan="7">
                    <div class="total-part">
                        ...
                        <div class="total-right w-15 float-left text-bold" align="right">
                            ...
                            $sales = DB::table('customers')->join('sales', 'sales.customer_id', '=',
                            'customers.id')->where('customers.id', $cusId)->sum('sales.due_amount');
                            @endphp
