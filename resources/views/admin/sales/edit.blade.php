    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>{{ trans('sidebar.sale.edit.edit sale') }}</h4>
                <h6>{{ trans('sidebar.sale.edit.edit your sale details') }}</h6>
            </div>
            <a href="{{ route('sale.index') }}" class="btn btn-info" >{{ trans('sidebar.sale.edit.back') }}</a>
        </div>
        <div class="card">
            <div class="card-body">
