                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <ul class="dropdown-menu"  >
                                        <li>
                                            <a href="{{ route('sale.pdf',[$sale->id]) }}" class="dropdown-item"><img src="{{asset('backend')}}/img/icons/download.svg" class="me-2" alt="img">Print Invoice</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('sale.challan.pdf',[$sale->id]) }}" class="dropdown-item"><img src="{{asset('backend')}}/img/icons/download.svg" class="me-2" alt="img">Print Challan</a>
                                        </li>
                                        @if(auth()->user()->user_role == 'admin')
                                        <li>
                                            <a href="{{ route('sale.delete',$sale->id) }}" class="dropdown-item confirm-text"><img src="{{asset('backend')}}/img/icons/delete1.svg" class="me-2" alt="img">{{ trans('table.sale.delete sale') }}</a>
                                        </li>
                                        @endif
                                    </ul>
                                </td>
