...
<div class="head-title">
   <center> <h1>{{ $sale->warehouse->name }}</h1> </center>
...
<div class="add-detail mt-10">
    <div class="w-50 float-left mt-10">
        ...
        <p class="m-0 pt-5 text-bold w-100">Order Date - <span class="gray-color">{{ Carbon\Carbon::parse($sale->created_at)->format('d-m-Y') }}</span></p>
    </div>
