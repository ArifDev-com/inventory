                ...
                <form action="{{ route('product.update', $product->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12 ">
                            <div class="form-group">
                                <label>{{ trans('edit-form.form.quantity') }}</label>
                        ...
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description"
                                    placeholder="{{ trans('form.form.enter description') }}">{{ $product->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <button type="submit" class="btn btn-submit me-2">{{ trans('edit-form.form.update')
                                }}</button>
