...
@section('scripts')
		...
		console.log(product);
			...
			var htmldata =`<tr>
						<input type="hidden" class="form-control barcode_url"  value="${product.barcode_url}">
                            ...
                            <input type="hidden" name="code[]" class="form-control code"  placeholder="Quantity here" value="${product.product_code}" style="width:200px;">
						...
						<td class="product">${product.product_code}</td>
						<td>
  ...
  $('.barcode_submit').click(function (e) { 
   ...
   for(var i = 0; i < quantity; i++) {
                    ...
                    $('#barcodeImg').append(`<div class="col-md-3" style="padding: 40px; border: 1px solid #adadad;" align="center">
                        <h5>${name}</h5>
