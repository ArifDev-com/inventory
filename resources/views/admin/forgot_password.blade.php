...
<body>
    ...
    <form action="{{route('update.otp')}}" method="post" class="login">
        ...
        <center>
            ...
            <a href="{{ route('login')}}" style="color: #242b77; font-size: 16px; font-weight: bold;">Back Login</a>
        ...
        <div class="links">
            <br>
            <center> Developed By: <a href="#" target="_blank" style="color: #4370b7; font-size: 18px;">Capital Lift
                    Ltd.</a></center>
