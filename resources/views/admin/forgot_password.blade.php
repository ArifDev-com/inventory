...
<body>
    <br><br>
    <center>
        <h1 style="color: white; margin-bottom: 10px;"><span class="">Forgot Password</span></h1>
    </center>
    ...
    <form action="{{route('update.otp')}}" method="post" class="login">
        @csrf


        <center>
            <div style="margin-top: -25px;">
                {{-- <img src="{{ asset($shopDocument->image) }}" alt="" style="height: 60px; width: 60px;"
                    class="img-fluid">
        ...
        <center>
            ...
            <a href="{{ route('login')}}"
                style="color: linear-gradient(45deg, red, #020285); font-size: 16px; font-weight: bold;">Back Login</a>
        ...
        <div class="links">
            <br>
            <center> Developed By: <a href="#" target="_blank" style="color: red" ); font-size: 18px;">Capital Lift
                    Ltd.</a></center>
