        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>{{ trans('sidebar.brand.body.brand list') }}</h4>
                    <h6>{{ trans('sidebar.brand.body.manage your brand') }}</h6>
                </div>
                <div class="page-btn">
                    <a href="{{ route('brand.create') }}" class="btn btn-added"><img
                            src="{{ asset('backend') }}/img/icons/plus.svg" class="me-2" alt="img">{{ trans('sidebar.brand.body.add brand') }}</a>
                </div>
            </div>
                        ...
                        <table class="table" id="example">
                            <thead>
                                <tr>
                                    ...
                                    <th>Sl</th>
                                    {{-- <th>{{ trans('table.brand.image') }}</th> --}}
                                    <th>{{ trans('table.brand.brand_name') }}</th>
                                    {{-- <th>{{ trans('table.brand.description') }}</th> --}}
                                    <th>{{ trans('table.brand.action') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($brands as $key=> $brand)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- <a class="me-3 confirm-text" href="{{ route('brand.destroy', $brand->id) }}">
