    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    <a href="{{ route('city.create') }}" class="btn btn-added"><img
                            src="{{ asset('backend') }}/img/icons/plus.svg" class="me-2" alt="img">Add City</a>
                </div>
            </div>
                            ...
                            <tbody>
                                @foreach ($cities as $city)
                                    <tr>
                                        ...
                                        <td>{{ $city->name }}</td>
                                        <td>
                                            <a class="me-3" href="{{ route('city.edit', $city->id) }}">
                                                <img src="{{ asset('backend') }}/img/icons/edit.svg" alt="img">
                                            </a>
                                            {{-- <a class="me-3 confirm-text" href="{{ route('city.destroy', $city->id) }}">
