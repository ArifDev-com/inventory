...
<div class="page-wrapper">
				<div class="content">
					<div class="page-header">
						...
						<div class="page-btn">
							<a href="{{route('permission.create')}}" class="btn btn-added"><img src="{{asset('backend')}}/img/icons/plus.svg" alt="img">Add Permission</a>
						</div>
					</div>
					<!-- /product list -->
					<div class="card">
								...
								<table class="table  " id="example">
									...
									<tbody>
										...
										<tr>
											...
											<td>Permission</td>
					                         <td>
												<a class="me-3" href="{{route('permission.edit',$permission->id)}}">
