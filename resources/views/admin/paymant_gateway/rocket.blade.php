            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card p-5 shadow bg-body rounded" style="margin-top: 50px;">
                        ...
                        <center>
                       <img src="{{ asset('paymant_gateway/rocket.png')}}" class="img-fluid mb-3" alt="" style="height: 80px; width: 120px;">
                    </center>
                ...
                @endphp 
                    ...
                    <div class="card p-3 mt-3" style="background-color: #89288f; color: white;">
                        <center><h6>Enter Transaction ID</h6></center>
                        <form action="">
                            <input type="text" id="first" class="form-control" placeholder="Enter Transaction ID">
                            <ul>
                                <br>
                                <li><p style="font-size: 11px; font-weight: bold;">Go to your ROCKET Mobile Menu by dialing: *322# or Open ROCKET App.</p></li>
                                <hr>
                                <li><p style="font-size: 14px; font-weight: bold;">Choose: <span class="text-warning">"Send Money"</span> </p></li>
                                <hr>
                                <li><p style="font-size: 14px; font-weight: bold;">Enter the Receiver Account Number <span class="text-warning">018305963128</span> </p></li>
                                <hr>
                                <li><p style="font-size: 14px; font-weight: bold;">Enter the amount: <span class="text-warning">500</span> </p></li>
                                <hr>
                                <li><p style="font-size: 14px; font-weight: bold;">Now enter your ROCKET Mobile Menu PIN to confirm.</p></li>
                                <hr>
                                <li><p style="font-size: 12px; font-weight: bold;">Done! You will receive a confirmation message from ROCKET</p></li>
                                <hr>
...
<form id="myForm" action="{{ route('update.payment.gateway.rocket',$user->id) }}" method="POST" >
    @csrf
    {{-- {{$user->id}} --}}
    ...
    <button type="submit" class="btn btn-primary mt-3" style="background-color: #89288f; display: inline-block; padding: 10px 20px; width: 100%; text-align: center;">VERIFY</button>
