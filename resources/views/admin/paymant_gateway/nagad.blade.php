            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card p-5 shadow bg-body rounded" style="margin-top: 50px;">
                        ...
                        <center>
                       <img src="{{ asset('paymant_gateway/nagad.png')}}" class="img-fluid mb-3" alt="" style="height: 80px; width: 120px;">
                    </center>
                ...
                @endphp 
                    ...
                    <div class="card p-3 mt-3" style="background-color: #c90008; color: white;">
                        <center><h6>Enter Transaction ID</h6></center>
                        
                            <input type="text" id="first" class="form-control" placeholder="Enter Transaction ID">
                            <ul>
                                <br>
                                <li><p style="font-size: 11px; font-weight: bold;">Go to your NAGAD Mobile Menu by dialing: *167# or Open NAGAD App.</p></li>
                                <hr>
                                ...
                                <hr>
                                <li><p style="font-size: 14px; font-weight: bold;">Now enter your NAGAD Mobile Menu PIN to confirm.</p></li>
                                <hr>
                                <li><p style="font-size: 12px; font-weight: bold;">Done! You will receive a confirmation message from NAGAD</p></li>
                                <hr>
...
<form id="myForm" action="{{ route('update.payment.gateway.nagad',$user->id) }}" method="POST" >
    @csrf
    {{-- {{$user->id}} --}}
    ...
    <button type="submit" class="btn btn-primary mt-3" style="background-color: #c90008; display: inline-block; padding: 10px 20px; width: 100%; text-align: center;">VERIFY</button>
