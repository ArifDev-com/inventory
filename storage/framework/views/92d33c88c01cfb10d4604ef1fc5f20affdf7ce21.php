<?php $__env->startSection('name', 'Sales order Reports'); ?>
...
<table style="padding-top: 5px; border-collapse: collapse; margin: auto; width: 100%;border: 1px solid #969696; " cellspacing="0" class="border">
  ...
  <tbody>
        ...
        <tr style="height: 17pt;">
            ...
            <td>
                <p class="s2" style="padding: 4px; padding-left: 2pt; text-indent: 0pt; text-align: center;">
                    <?php echo e($total_due); ?>

                </p>
            </td>
            <td>
                <p class="s2" style="padding: 4px; padding-left: 2pt; text-indent: 0pt; text-align: center;">
                    <?php echo e($total_paid); ?>

                </p>
            </td>
            <td>
                <p class="s2" style="padding: 4px; padding-left: 2pt; text-indent: 0pt; text-align: center;">
                    <?php echo e($total_grandtotal); ?>
    ...
    <tbody>
        ...
        <?php
            ...
            $pays = \App\Models\CutomerPayment::query()
                ...
                ->get();
        ?>
        <?php $__currentLoopData = $pays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr style="height: 17pt;">
            <td>
                <p class="s2" style="padding: 4px; text-indent: 0pt; text-align: center;">
            ...
            <td>
                <p class="s2" style="padding: 4px; padding-left: 2pt; text-indent: 0pt; text-align: center;">
                    <?php echo e($payment->sale?->discount); ?>
...
<table style="border-collapse: collapse; margin-top: 5px; width: 100%;">
    <tr>
        ...
        <td style="text-align: center; padding: 5px; border: 1px solid #969696;">
            <?php echo e(\App\Models\Sale::whereBetween('created_at', [$fromDate, $toDate])->sum('grandtotal')); ?>
    ...
    <tr>
        ...
        <td style="text-align: center; padding: 5px; border: 1px solid #969696;">
            <?php echo e(App\Models\CutomerPayment::where('payment_method', 'bank')
                 ->whereBetween('created_at', [$fromDate, $toDate])
                 ->with('sale')
                 ->sum('paying_amount')); ?>
        ...
        <td style="text-align: center; padding: 5px; border: 1px solid #969696;">
            <?php echo e(\App\Models\CutomerPayment::whereBetween('created_at', [$fromDate, $toDate])
    ...
    <tr>
        ...
        <td style="text-align: center; padding: 5px; border: 1px solid #969696;">
                <?php echo e(App\Models\CutomerPayment::whereIn('payment_method', ['bkash', 'rocket', 'nagad'])
                        ->whereBetween('created_at', [$fromDate, $toDate])
                        ->with('sale')
                        ->sum('paying_amount')); ?>
        ...
        <td style="text-align: center; padding: 5px; border: 1px solid #969696;">
            <?php echo e(App\Models\AdvancePayment::whereBetween('created_at', [$fromDate, $toDate])
            ->sum('amount')); ?>
    ...
    <tr>
        ...
        <td style="text-align: center; padding: 5px; border: 1px solid #969696;">
                <?php echo e(App\Models\Sale::whereBetween('created_at', [$fromDate, $toDate])
                                      ->where('other_cost', '>', 0)
                                      ->with('customer')
                                    ->sum('other_cost')); ?>
    ...
    <tr>
        ...
        <td style="text-align: center; padding: 5px; border: 1px solid #969696;">
            <?php echo e(App\Models\CutomerPayment::where('payment_method', 'advance')
                                    ->whereBetween('created_at', [$fromDate, $toDate])
                                      ->with('sale')
                                    ->sum('paying_amount')); ?>
    ...
    <tr>
        ...
        <td style="text-align: center; padding: 5px; border: 1px solid #969696;">
                <?php echo e(App\Models\SaleReturn::whereBetween('created_at', [$fromDate, $toDate])
                                      ->where('paid_amount', '>', 0)
                                      ->with('customer')
                                    ->sum('paid_amount')); ?>
    ...
    <tr>
        ...
        <td style="text-align: center; padding: 5px; border: 1px solid #969696;">
            <?php echo e(App\Models\Expense::whereBetween('created_at', [$fromDate, $toDate])
                            ->with('customer')
                            ->sum('amount')); ?>
...
<?php echo $__env->make('layouts.pdf', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ariful/Developer/Personal_Projects/Inventory/inventory/resources/views/admin/reports/datewise-sale-report-print.blade.php ENDPATH**/ ?>