            ...
            <div class="form-group">
                ...
                >
                    <?php if($selected_customer ?? null): ?>
                        <option value="<?php echo e($selected_customer->id); ?>"><?php echo e($selected_customer->name); ?></option>
                    <?php endif; ?>
                </select>
...
<script>
    let all_customers = <?php echo json_encode(\App\Models\Customer::query()->with(['sales'])->get(), 15, 512) ?>;
...
<?php /**PATH /Users/ariful/Developer/Personal_Projects/Inventory/inventory/resources/views/common/customer.blade.php ENDPATH**/ ?>