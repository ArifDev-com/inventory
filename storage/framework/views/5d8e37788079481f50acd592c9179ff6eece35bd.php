...
<head>
    ...
    <title>
        <?php echo $__env->yieldContent('name'); ?> Page
    </title>
    <style type="text/css">
        html,
        body {
...
<body>
    <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 30px;">
        <tbody>
            <tr>
                <td>
                    <img src="<?php echo e('data:image/png;base64,' . base64_encode(file_get_contents(public_path('logo2.png')))); ?>"
...
</html><?php /**PATH /Users/ariful/Developer/Personal_Projects/Inventory/inventory/resources/views/layouts/pdf.blade.php ENDPATH**/ ?>