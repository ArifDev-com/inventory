...
<head>
    ...
    <!-- Datetimepicker CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('backend')); ?>/css/bootstrap-datetimepicker.min.css">
    ...
    <!-- Owl Carousel CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('backend')); ?>/plugins/owlcarousel/owl.carousel.min.css">

    <!-- Datatable CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('backend')); ?>/css/dataTables.bootstrap4.min.css">

    <!-- Fontawesome CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('backend')); ?>/plugins/fontawesome/css/fontawesome.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('backend')); ?>/plugins/fontawesome/css/all.min.css">
...
<body>
   ...
   <div class="whirly-loader"> </div>
    ...
    <!-- Feather Icon JS -->
    <script src="<?php echo e(asset('backend')); ?>/js/feather.min.js"></script>
    ...
    <script src="<?php echo e(asset('backend')); ?>/js/dataTables.bootstrap4.min.js"></script>

    <!-- Bootstrap Core JS -->
    <script src="<?php echo e(asset('backend')); ?>/js/bootstrap.bundle.min.js"></script>

    <!-- Owl JS -->
    <script src="<?php echo e(asset('backend')); ?>/plugins/owlcarousel/owl.carousel.min.js"></script>
    ...
    <!-- Chart JS -->
    <script src="<?php echo e(asset('backend')); ?>/plugins/apexchart/apexcharts.min.js"></script>
    <script src="<?php echo e(asset('backend')); ?>/plugins/apexchart/chart-data.js"></script>
...
</html><?php /**PATH /Users/ariful/Developer/Personal_Projects/Inventory/inventory/resources/views/layouts/app.blade.php ENDPATH**/ ?>