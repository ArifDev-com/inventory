                            ...
                            <div class="col-lg-2 col-sm-6 col-12">
                                <div class="form-group">
                                    <input type="text" class="datetimepicker cal-icon" placeholder="Choose Start Date" required
                                        name="from_date" value="<?php echo e(\Carbon\Carbon::parse($fromDate)->format('d-m-Y')); ?>">
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-6 col-12">
                                <div class="form-group">
                                    <input type="text" class="datetimepicker cal-icon" placeholder="Choose End Date" required
                                        name="to_date" value="<?php echo e(\Carbon\Carbon::parse($toDate)->format('d-m-Y')); ?>">
                                </div>
                            </div>
                            <div class="col-lg-2 ">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ariful/Developer/Personal_Projects/Inventory/inventory/resources/views/admin/reports/product-added-report.blade.php ENDPATH**/ ?>